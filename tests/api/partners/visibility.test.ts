import * as handler from "@api/partners/visibility/route";
...
jest.mock("@/prisma/prisma-client", () => ({
  __esModule: true,
  default: {
    partners_on_entities: { update: jest.fn(), findUnique: jest.fn() },
...
describe("/partners/visibility", () => {
  ...
  it("200 GET возвращает запись", async () => {
    prisma.partners_on_entities.findUnique.mockResolvedValueOnce({ is_visible: true });
