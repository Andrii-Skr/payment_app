...
import * as handler from "@api/spec-docs/unpay/route";
import { Roles } from "@/constants/roles";

jest.mock("@/prisma/prisma-client", () => ({
  __esModule: true,
  default: {
    spec_doc: { findUnique: jest.fn(), update: jest.fn() },
...
describe("PATCH /spec-docs/unpay", () => {
  ...
  it("404 если не найдено", async () => {
    prisma.spec_doc.findUnique.mockResolvedValueOnce(null);
